            ...
            {templates.map((tpl) => (
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-1 text-[11px] text-slate-500 font-mono">
                      ...
                      <span>{Array.isArray(tpl.nodes) ? tpl.nodes.length : 0} Components</span>
                    </div>
                  </div>
                ...
                <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between">
                  <span className="text-[11px] text-slate-500 font-medium">Built-in Template</span>
                  <button
                  ...
                  >
                    ...
                    <span>{forkMutation.isPending ? 'Forking Template...' : 'Fork into My Projects'}</span>
                  </button>
                </div>
              </div>
            ))}
