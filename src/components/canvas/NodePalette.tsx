...
const AVAILABLE_COMPONENTS: ComponentDefinition[] = [
  {
    ...
    label: "API Gateway",
    category: "network",
    description: "Entrypoint router & auth",
    icon: "Shield",
  },
  {
    type: "load-balancer",
  ...
  },
  {
    ...
    label: "Microservice",
    category: "compute",
    description: "Business logic worker",
    icon: "Cpu",
  },
  {
    type: "database",
    label: "Database",
    category: "storage",
    description: "Relational DB instance",
    icon: "Database",
  },
  {
    type: "postgresql",
  ...
  },
  {
    ...
    label: "Kafka Stream",
    category: "messaging",
    description: "Distributed event log",
    icon: "Layers",
  },
  {
    type: "rabbitmq",
  ...
  },
  {
    ...
    label: "Global CDN",
    category: "network",
    description: "Edge content caching",
    icon: "Globe",
  },
  {
